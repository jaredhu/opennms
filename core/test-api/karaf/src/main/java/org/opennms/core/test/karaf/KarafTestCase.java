...
public abstract class KarafTestCase {
    ...
    protected Option[] configAsArray() {
        ...
        Option[] options = new Option[]{
            ...
            editConfigurationFilePut("etc/startup.properties", "mvn:net.java.dev.jna/jna/4.5.1", "5"),
            editConfigurationFilePut("etc/startup.properties", "mvn:net.java.dev.jna/jna-platform/4.5.1", "5"),
